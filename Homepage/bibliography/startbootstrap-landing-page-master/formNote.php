      ...
      <form id="check-form" method="post">
        <div class="table-wrapper-scroll-y my-custom-scrollbar" style="height: 450px; background-color: white;">
          <table class="table table-bordered table-striped mb-0" id="tableAuthor" style='border-collapse: collapse;'>
            ...
            $query1 = "select b_name, b_title, b_journal_name from search where user_id = {$_SESSION['user_id']}";
            // $query2 = "select name, title, journal_name from author_test where user_id = {$_SESSION['user_id']}";
            ...
            //   $title2 = $row2['title'];
              ...
              $journal1 = $row1['b_journal_name'];
            //   $journal2 = $row2['journal_name'];
            ?>
