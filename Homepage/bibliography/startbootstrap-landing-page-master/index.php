    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" id="update">
          <input type="hidden" name="function" value="update_func">
          ...
          <div class="form-group">
            ...
            <div class="table-responsive">
              <table id="dynamic_field">
                <tr>
                  <td class="text" style="padding-left: 25px;">AUTHOR&nbsp;&nbsp;</td>
                  <td><input type="text" name="name_update" id="name_update" class="form-control name_list" style="width: 400px;" /></td>
          ...
          <div class="form-group" id="Dtitle">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">TITLE&nbsp;&nbsp;:</p>
            <input type="text" id="title_update" class="form-control"  style="display: inline; padding-right: 0px; width: 650px;">
          </div>
          <div class="form-group" id="Djournal_name">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">JOURNAL NAME&nbsp;&nbsp;:</p>
            <input type="text" id="journal_name_update" class="form-control"  style="display: inline; padding-right: 0px; width: 75%;">
          </div>
          <div class="form-group" id="Dperiodical_name">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">PERIODICAL TITLE&nbsp;&nbsp;:</p>
            <input type="" id="periodical_name_update" class="form-control" style="display: inline; padding-right: 0px; width: 75%;">
          </div>
          <div class="form-group" id="Dcity">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">CITY&nbsp;&nbsp;:</p>
            <input type="text" id="city_update" class="form-control" style="width: 500px; display: inline-block; padding-right: 0px; ">
          </div>
          <div class="form-group" id="DdateP">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">DATE PUBLISHED&nbsp;&nbsp;:</p>
            <input type="text" id="dayP_update" class="form-control" style="width: 150px; display: inline-block; padding-right: 0px;">
            <input type="text" id="monthP_update" class="form-control" style="width: 150px; display: inline-block; padding-right: 0px;">
            <input type="text" id="yearP_update" class="form-control" style="width: 150px; display: inline-block; padding-right: 0px;">
          </div>
          <div class="form-group" id="Dpages">
            <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">PAGES&nbsp;&nbsp;:</p>
            <input type="text" id="pages_update" class="form-control" style="width: 500px; display: inline-block; padding-right: 0px; ">
          </div>
          ...
          <div id="demo" class="collapse">
            <div class="md-form">
              <div class="form-group" id="Deditor">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">EDITOR&nbsp;&nbsp;:</p>
                <input type="text" id="editor_update" class="form-control" placeholder="Kramer, James D; Chen, Jacky" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dpublisher">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">PUBLISHER&nbsp;&nbsp;:</p>
                <input type="text" id="publisher_update" class="form-control" placeholder="Adventure Works Monthly" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dedition">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">EDITON&nbsp;&nbsp;:</p>
                <input type="text" id="edition_update" class="form-control" placeholder="Weekend" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dvolume">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">VOLUME&nbsp;&nbsp;:</p>
                <input type="text" id="volume_update" class="form-control" placeholder="III" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dissue">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">ISSUE&nbsp;&nbsp;:</p>
                <input type="text" id="issue_update" class="form-control" placeholder="12" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dshort_title">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">SHORT TITLE&nbsp;&nbsp;:</p>
                <input type="text" id="short_title_update" class="form-control" placeholder="Bibliographies" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dstandard_num">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">STANDARD NUMBER&nbsp;&nbsp;:</p>
                <input type="text" id="standard_num_update" class="form-control" placeholder="ISBN/ISSN" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dcomment">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">COMMENTS&nbsp;&nbsp;:</p>
                <input type="text" id="comment_update" class="form-control" placeholder="enter comment about this source" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="Dmedium">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">MEDIUM&nbsp;&nbsp;:</p>
                <input type="text" id="medium_update" class="form-control" placeholder="Document" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
              <div class="form-group" id="DdateACC">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">DATE ACCESSED&nbsp;&nbsp;:</p>
                <input type="text" id="dayACC_update" class="form-control" placeholder="1" style="width: 150px; display: inline-block; padding-right: 0px;">
                <input type="text" id="monthACC_update" class="form-control" placeholder="January" style="width: 150px; display: inline-block; padding-right: 0px;">
                <input type="text" id="yearACC_update" class="form-control" placeholder="2006" style="width: 150px; display: inline-block; padding-right: 0px;">
              </div>
              <div class="form-group" id="Durl">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">URL&nbsp;&nbsp;:</p>
                <input type="text" id="url_update" class="form-control" placeholder="http://www.adatum.com" style="width: 650px; display: inline-block; padding-right: 0px;">
              </div>
              <div class="form-group" id="Ddoi">
                <p class="text" style="padding-left: 25px; padding-right: 10px; display: inline-block;">DOI&nbsp;&nbsp;:</p>
                <input type="text" id="doi_update" class="form-control" placeholder="10.1000/182" style="width: 500px; display: inline-block; padding-right: 0px; ">
              </div>
