      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="hidden_id" name="hidden_id" />
          ...
          <div class="form-group" id="Djournal_name">
            ...
            <input type="text" id="journal_nameB" name="journal_nameB" class="form-control" placeholder="Adventure Works Monthly" style="display: inline; width: 77%;">
          </div>
          <div class="form-group" id="Dperiodical_name">
            <p class="text" style="display: inline-block;">PERIODICAL TITLE&nbsp;&nbsp;:</p>
            <input type="text" id="periodical_nameB" name="periodical_nameB" class="form-control" placeholder="Adventure Works Daily" style="display: inline; width: 75%;">
          </div>
          <div class="form-group" id="DdateP">
            <p class="text" style="display: inline-block;">DATE PUBLISHED&nbsp;&nbsp;:</p>
            <input type="text" id="dayPB" name="dayPB" class="form-control" placeholder="1" style="width: 20%; display: inline-block;">
            <input type="text" id="monthPB" name="monthPB" class="form-control" placeholder="January" style="width: 20%; display: inline-block;">
            <input type="text" id="yearPB" name="yearPB" class="form-control" placeholder="2006" style="width: 20%; display: inline-block;">
          </div>
          <div class="form-group" id="Dpages">
            <p class="text" style="display: inline-block;">FROM PAGE&nbsp;&nbsp;:</p>
            <input type="text" id="page_startB" name="page_startB" class="form-control" placeholder="50" style="width: 25%; display: inline-block;">
            <p class="text" style="display: inline-block;">TO PAGE&nbsp;&nbsp;:</p>
            <input type="text" id="page_endB" name="page_endB" class="form-control" placeholder="62" style="width: 25%; display: inline-block;">
          </div>
          <div class="form-group" id="Dvolume" style="display: inline-block">
            <p class="text" style="display: inline-block;">VOLUME&nbsp;&nbsp;:</p>
            <input type="text" id="volumeB" name="volumeB" class="form-control" placeholder="III" style="width: 60%; display: inline-block;">
          </div>
          <div class="form-group" id="Dissue" style="display: inline-block">
            <p class="text" style="display: inline-block;">ISSUE&nbsp;&nbsp;:</p>
            <input type="text" id="issueB" name="issueB" class="form-control" placeholder="12" style="width: 60%; display: inline-block;">
          </div><br/>
          ...
          <div class="form-group" id="Ddoi">
            ...
            <input type="text" id="doiB" name="doiB" class="form-control" placeholder="10.1000/182" style="width: 70%; display: inline-block;">
          </div>
      </div>
      <!-- <div style="clear:both;"></div> -->
      <div class="modal-footer">
        <!-- <input type="hidden" name="author_id" id="author_id" /> -->
        <input type="submit" name="insertSubmit" id="insertSubmit" class="btn btn-info" value="Submit" >  
      </div>
        </from>
    </div>
  </div>
