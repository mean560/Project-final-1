    ...
    <div class="wrapper">
        <div class="header">
            <div class="container-fluid">
                <div class="w3-bar">
                    <a href="./authen/signin.php"><button class="w3-button w3-right" type="submit" style="background:#007398;color: white;border: 2px solid #007398">Sign in</button></a>
                    <a href="./authen/register.php"><button class="w3-button w3-right" type="submit" style="background:white;color: black; border: 2px solid #007398;">Register</button></a>
                </div>
            </div>
        </div> <!--  header -->
        <div class="middle">
